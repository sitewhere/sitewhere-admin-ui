  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        >{{ fourDecimalPlaces(props.item.latitude) + ', ' + utils.fourDecimalPlaces(props.item.longitude) + ', ' + utils.fourDecimalPlaces(props.item.elevation) }}</td>
        <td
          width="10%"
          style="white-space: nowrap"
          :title="utils.formatDate(props.item.eventDate)"
...
export default {
  ...
  methods: {
    ...
    refresh: function() {
      ...
      listLocationsForArea(this.$store, areaToken, paging)
