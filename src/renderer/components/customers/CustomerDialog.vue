    ...
    >
      <v-tabs v-model="active">
        <v-tabs-bar dark color="primary">
          <v-tabs-item key="details" href="#details">Customer Details</v-tabs-item>
                ...
                <v-container fluid>
                  <v-layout row wrap>
                    <v-flex xs12>
                      ...
                      <div class="verror">
                        <span
                          v-if="!$v.customerToken.required && $v.$dirty"
                        >Customer token is required.</span>
                        <span
                          v-if="!$v.customerToken.validToken && $v.$dirty"
                        >Customer token is not valid.</span>
                      </div>
                    </v-flex>
                    <v-flex xs12>
                      <v-text-field
                      ...
                      <div class="verror">
                        <span
                          v-if="$v.customerName.$invalid && $v.$dirty"
                    ...
                    <v-flex xs12>
                      ...
                      <div class="verror">
                        <span
                          v-if="$v.customerTypeId.$invalid && $v.$dirty"
                    ...
                    <v-flex xs12>
                      ...
                      <div class="verror">
                        <span
                          v-if="$v.customerDescription.$invalid && $v.$dirty"
...
export default {
  ...
  methods: {
    ...
    generatePayload: function() {
      ...
      payload.parentCustomerToken = this.parentCustomer
        ? this.parentCustomer.token
        : null;
