<template>
  <div>
    <v-data-table v-if="locations && locations.length > 0"
      ...
      :hide-actions="true" no-data-text="No Locations Found for Customer"
      :total-items="0">
...
import {_listLocationsForCustomer} from '../../http/sitewhere-api-wrapper'
...
export default {
  ...
  methods: {
    ...
    refresh: function () {
      ...
      _listLocationsForCustomer(this.$store, customerToken, paging)
