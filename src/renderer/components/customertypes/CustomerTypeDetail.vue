<template>
  <div>
    <navigation-page v-if="customerType" icon="fa-map"
          ...
          <v-tabs-items>
            <v-tabs-content key="instances" id="instances">
              <v-container fluid grid-list-md v-if="customers">
                <v-layout row wrap>
                  <v-flex xs6 v-for="(customer, index) in customers"
                    :key="customer.token">
      ...
      <div slot="actions">
        <navigation-action-button icon="fa-edit" tooltip="Edit Customer Type"
          @action="onEdit">
        </navigation-action-button>
        <navigation-action-button icon="fa-times" tooltip="Delete Customer Type"
          @action="onDelete">
        </navigation-action-button>
      </div>
    </navigation-page>
