<template>
  <div>
    <v-chip @click="onChipClicked" :color="backgroundColor" :text-color="foregroundColor">
      <component-status-icon :status="tenantState.componentState.status">
      </component-status-icon>
      {{ tenantState.microservice.hostname }} ({{ tenantState.componentState.status }})
    </v-chip>
    <tenant-engine-components-dialog :tenantState="tenantState"
      :dialogVisible="dialogVisible" @closeClicked="onCloseClicked">
