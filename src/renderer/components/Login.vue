...
const discordTitle: string = "Get Support on the SiteWhere Discord Server";

// Website logo and tooltip.
const websiteSvgContent: string =
...
const websiteTitle: string = "Visit the SiteWhere Community Website";

// GitHub logo and tooltip.
const githubSvgContent: string =
...
const githubTitle: string = "View Repository on GitHub";

// Twitter logo and tooltip.
const twitterSvgContent: string =
...
const twitterTitle: string = "Follow SiteWhere on Twitter";
