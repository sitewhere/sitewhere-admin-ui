    ...
    <main>
      ...
      <v-container>
        <div class="login-wrapper">
          ...
          <remotes-dialog ref="remotesDialog" @save="onRemotesUpdated" />
        </div>
      </v-container>
...
const discordTitle = "Get Support on the SiteWhere Discord Server";

// Website logo and tooltip.
const websiteSvgContent =
...
const websiteTitle = "Visit the SiteWhere Community Website";

// GitHub logo and tooltip.
const githubSvgContent =
...
const githubTitle = "View Repository on GitHub";

// Twitter logo and tooltip.
const twitterSvgContent =
...
const twitterTitle = "Follow SiteWhere on Twitter";
...
export default class Login extends Vue {
  ...
  websiteSvgContent: string = websiteSvgContent;
  websiteTitle: string = websiteTitle;
  githubSvgContent: string = githubSvgContent;
  ...
  async onLogin() {
    ...
    try {
      ...
      const jwt: string = response.headers["x-sitewhere-jwt"];
  ...
  async onJwtAcquired() {
    try {
      ...
      const response: AxiosResponse<IUser> = await getUser(
        this.$store,
        this.username,
        format
      );
